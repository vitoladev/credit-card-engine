...
SQS redelivery (`maxReceiveCount` of 5, the AWS recommendation for a Lambda
source; it was 3 when this ADR was written) lands in the DLQ and becomes a failed item.
