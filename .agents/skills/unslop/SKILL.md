...
name: unslop
description: |
  Cut AI tells from any writing — layer diffs, docs, PR titles/bodies,
  comments, UI copy. Use as /unslop, or whenever create-pr /
  maintain-pr-description / task-orchestrator requires an unslop pass.
---
...
- When unslopping a **layer diff**, skip generated files, lockfiles,
  binaries, fixtures, and snapshots. Do not rename API identifiers.
- The repo's docs prose uses em dashes as sentence/list separators; keep
  them. Rule 13 applies to AI-em-dash clutter, not this house style.
...
26. **Abstract metaphor nouns.** Substrate, wedge, vector, locus, vantage, nexus, primitive (as noun), harness (as metaphor), surface (as in "API surface"), bedrock, scaffolding (as metaphor), modality, paradigm, gold-plating, ratchet (as metaphor), evacuate (for moving code), endgame, north star, flywheel. These read as technical but usually have a plainer concrete word. "Substrate" becomes "base". "Wedge in" becomes "add". "Vector" becomes "way" or "method". "Gold-plating" becomes "more than the job needs". "Ratchet" becomes the mechanism's real name or "a limit that only tightens". "Evacuate" becomes "move out". "Endgame" becomes "the last phase". Pick the concrete word. Exception in this repo: keep glossary / Docs prose names (see above), including "App Router surface".
